...
stock_code_list = ['sh603316', 'sz000001', 'sh603317', 'sz000002', 'sh603318', 'sz000003', 'sh603319', 'sz000004', 'sh603320', 'sz000005', ''] #在后面添加,' '即可，注意一定要用英文符号
...
# =====保存数据
df.to_csv('winder_stock_data.csv', index=False)
